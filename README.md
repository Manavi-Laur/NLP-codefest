...
>6. Spell Check(extra step): Using spellchecker library (spell.correction()). But, it converts words like-
   "nlp" to nap,
   "omg" to om,
...
>7. Removal of stopwords: Using nltk library, using stopwords corpus #comment: in today's context: words like omg, btw, lol can be treated as stopwords.
>8. Vectorisation Preview: Making a dictionary with words as keys and their frequency as values.
